...
import { Eye, ArrowRight, Camera, TrendingUp, Users } from "lucide-react";

const LongbyteProducts = () => {
    return (
                    ...
                    <Card className="relative overflow-hidden group hover:shadow-elegant transition-all duration-500 transform hover:scale-[1.02] border-border/50 bg-card/50 backdrop-blur-sm">
                        ...
                        <div className="relative p-8">
                            ...
                            <div className="flex items-center mb-8">
                                ...
                                <div>
                                    <h3 className="text-4xl font-bold text-card-foreground group-hover:gradient-text transition-all duration-300">
                                        Peekaboo
                                    </h3>
                            ...
                            <div className="mb-8 p-6 bg-surface/50 rounded-lg border border-border/30">
                                <h4 className="text-xl font-semibold text-card-foreground mb-4">The Travel Problem</h4>
                            ...
                            {/* Solution */}
                            <div className="mb-8">
                                <h4 className="text-2xl font-semibold text-card-foreground mb-4">Our Solution</h4>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                <div className="p-6 bg-surface/50 rounded-lg border border-border/30 text-center">
                                    ...
                                    <h5 className="text-lg font-semibold text-card-foreground mb-2">🔴 Live Streams</h5>
                                ...
                                <div className="p-6 bg-surface/50 rounded-lg border border-border/30 text-center">
                                    ...
                                    <h5 className="text-lg font-semibold text-card-foreground mb-2">📊 Predictive Trends</h5>
                                    <p className="text-muted-foreground">Best days/times to visit based on historical data and patterns</p>
                                </div>
                                <div className="p-6 bg-surface/50 rounded-lg border border-border/30 text-center">
                                    <Users className="w-12 h-12 text-accent mx-auto mb-4" />
                                    <h5 className="text-lg font-semibold text-card-foreground mb-2">🧭 Local Insights</h5>
...
export default LongbyteProducts;
